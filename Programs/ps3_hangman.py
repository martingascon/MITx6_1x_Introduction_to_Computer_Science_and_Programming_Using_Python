...
WORDLIST_FILENAME = "/Users/martin/Dropbox/Personal/Coursera/p_python/eDX_python/Programs/words.txt"
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while game:  
        ...
        print getAvailableLetters(Guessed)
        ...
        if type(guess) != str:
            ...
            guess = guess[0].lower()
	    guesses_left-=1
            if guess in getAvailableLetters(Guessed):
