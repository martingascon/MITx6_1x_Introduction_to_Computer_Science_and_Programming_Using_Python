...
# (the "test character"). If they are the same, we are done - we've found the character we're looking for!
...
# to test if char is in aStr. char will be a single character and aStr will be a string that is in alphabetical order. 
...
print isIn('k', '')
print isIn('l', 'abcfhk')
print isIn('b', 'abcdefghijklmnopq')
print isIn('c', 'aefghklmo')
print isIn('d', 'abcd')           
